...
learning_rate_phase2=${17:-"0.00015625"}
warmup_proportion_phase2=${18:-"0.0125"}
train_steps_phase2=${19:-25000}
gradient_accumulation_steps_phase2=${20:-1}

BERT_PREP_WORKING_DIR=$HOME/workspace/nv_bert/data
DATASET=hdf5_lower_case_1_seq_len_128_max_pred_20_masked_lm_prob_0.15_random_seed_12345_dupe_factor_5/books_wiki_en_corpus
...
WORKSPACE=$HOME/workspace/nv_bert
CODEDIR=${23:-$WORKSPACE}
init_checkpoint=${24:-"None"}

num_nodes=${25:-4}
node_rank=${26:-0} # you need to change this on every node
master_address=${27:-"10.0.207.146"}
port=${28:-21045}
...
CMD=" $CODEDIR/run_pretraining_conef.py"
...
#CMD="python3 -m torch.distributed.launch --nproc_per_node=$num_gpus --nnodes=$num_nodes --node_rank=$node_rank --master_addr=$master_address --master_port=$port $CMD"
#
#
